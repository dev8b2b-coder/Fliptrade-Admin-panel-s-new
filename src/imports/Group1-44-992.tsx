...
function Logo() {
  return <div className="absolute bg-[71.47%_52.84%] bg-no-repeat bg-size-[218.93%_258.5%] h-[54.382px] left-[81.57px] top-0 w-[138.427px]" data-name="logo" style={{ backgroundImage: `url('${imgLogo}')` }} />;
}
